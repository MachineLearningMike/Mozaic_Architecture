...
- When the system **stake**s asset that a user **deposit**ed, the system returns LP tokens to the user. The amount of the returned LP token should represent the newly staked asset in the **Staking stock** immediately after the asset is staked.
...
- The system should make sure that only the system can **stake** deposited asset, subtract from **stake**d asset, collect reward, and **compound** reward.
<br><br>
